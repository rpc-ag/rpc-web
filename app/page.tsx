...
export default function Home() {
  ...
  const handleLaunchSimulator = useCallback(() => {
    document.getElementById("gateway-sim")?.scrollIntoView({ behavior: "smooth" });
  }, []);
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16 items-center">
              ...
              <div className="hidden md:flex space-x-8">
                <a href="#vision" className="text-gray-600 hover:text-blue-600 transition-colors text-sm font-medium">
                  Vision
                </a>
                <a
                  href="#gateway-sim"
                ...
                <a href="#stack" className="text-gray-600 hover:text-blue-600 transition-colors text-sm font-medium">
                  The Stack
                </a>
              </div>
              <button
                onClick={handleLaunchSimulator}
                className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
              >
                Launch Simulator
              </button>
            </div>
